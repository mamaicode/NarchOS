...
// ALL INFO PROVIDE ON https://wiki.osdev.org/Interrupt_Descriptor_Table
...
void idt_set(int interrupt_no, void* address)
{
    ...
    desc->type_attr = 0x0EE;                                // The reason its not 0E, is because we have to take in account to set the other bits 
